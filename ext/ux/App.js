...
Ext.extend(Ext.App, Ext.util.Observable, {
    ...
    STATUS_VALIDATION_ERROR :   "Validaci&oacute;n",
    STATUS_ERROR:               "ERROR",
    STATUS_NOTICE:              "Notificaci&oacute;n",
    STATUS_OK:                  "Confirmaci&oacute;n",
    STATUS_HELP:                "Ayuda",
    STATUS_ATENCION:            "Atenci&oacute;n !",
    ...
    buildMessageBox : function(title, msg) {
        ...
        /*return [
            '<div class="app-msg" style="background-color: #01DF74;">',
            '<div class="x-box-tl" style="background-color: #01DF74;">\n\
            <div class="x-box-tr" style="background-color: #01DF74;">\n\
            <div class="x-box-tc" style="background-color: #01DF74;"></div></div></div>',
            '<div class="x-box-ml" style="background-color: #01DF74;">\n\
            <div class="x-box-mr" style="background-color: #01DF74;"><div class="x-box-mc" style="background-color: #01DF74;">\n\
            <h3 class="x-icon-text icon-status-' + title + '" style="background-color: #01DF74;">', title, '</h3>', msg, '</div></div></div>',
            '<div class="x-box-bl" style="background-color: #01DF74;">\n\
            <div class="x-box-br" style="background-color: #01DF74;"><div class="x-box-bc" style="background-color: #01DF74;"></div></div></div>',
            '</div>'
        ].join('');*/
