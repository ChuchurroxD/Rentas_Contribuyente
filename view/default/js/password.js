...
$(function() {
    $('#update_datos').on('click', function(){        
       ...
       var param_actual_password = document.getElementById('param_actual_password').value;
       ...
       if (param_new_usuario == '' || param_actual_password =='' || param_nuevo_password =='' || param_confirmar_password == '') {
        alert('Ingrese todos los campos.');
       } else {
        if (param_contraseña != param_actual_password) {
