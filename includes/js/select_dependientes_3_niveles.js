...
listadoSelects2[0]="selecc1";
listadoSelects2[1]="selecc2";
listadoSelects2[2]="selecc3";
...
function cargaContenido2(idSelectOrigen)
{
	...
	if(opcionSeleccionada==0)
	{
		...
		while(listadoSelects2[x])
		{
			...
			var nuevaOpcion=document.createElement("option2"); nuevaOpcion.value=0; nuevaOpcion.innerHTML="Selecciona Opci&oacute;n...";
	...
	else if(idSelectOrigen!=listadoSelects2[listadoSelects2.length-1])
	{
		...
		{ 
			if (ajax.readyState==1)
			{
				...
				var nuevaOpcion=document.createElement("option2"); nuevaOpcion.value=0; nuevaOpcion.innerHTML="Cargando...";
