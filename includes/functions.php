...
list($dia1, $mes1, $ano1) = split("[/.-]", $ini);
list($dia2, $mes2, $ano2) = split("[/.-]", $fin);
...
//convierto segundos en dñas 
$dias_diferencia = $segundos_diferencia / (60 * 60 * 24); 

//obtengo el valor absoulto de los dñas (quito el posible signo negativo) 
$dias_diferencia = abs($dias_diferencia); 

//quito los decimales a los dñas de diferencia 
...
function FechaFormateada($FechaStamp){
	...
	switch($dialetra){
		...
		case 3: $dialetra="Miñrcoles"; break;
		case 4: $dialetra="Jueves"; break;
		case 5: $dialetra="Viernes"; break;
		case 6: $dialetra="Sñbado"; break;
	}
	switch($mes) {
...
switch($dias) {
case 'Lunes': $mesletra="1"; break;
case 'Martes': $mesletra="2"; break;
case 'Miercoles': $mesletra="3"; break;
case 'Jueves': $mesletra="4"; break;
case 'Viernes': $mesletra="5"; break;
case 'Sabado': $mesletra="6"; break;
case 'Domingo': $mesletra="7"; break;
}    
return "$mesletra";
}
...
switch($dias) {
case '1': $mesletra="Lunes"; break;
case '2': $mesletra="Martes"; break;
case '3': $mesletra="Miercoles"; break;
case '4': $mesletra="Jueves"; break;
case '5': $mesletra="Viernes"; break;
case '6': $mesletra="Sabado"; break;
case '7': $mesletra="Domingo"; break;
}    
return "$mesletra";
}
