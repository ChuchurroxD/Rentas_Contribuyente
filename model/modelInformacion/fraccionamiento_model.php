    ...
    function mostrar_fraccionamientos() {  
        ...
        while (odbc_fetch_row($this->result)) {   
            ...
            echo'<tr>
                ...
                <td style="text-align: left; font-size: 9px; width: 12%; color: #000;">'.utf8_encode($base_legal).'</td>
                <td style="text-align: left; font-size: 9px; width: 14%; color: #000;">'.utf8_encode($Fecha_Acogida).'</td>
                <td style="text-align: left; font-size: 9px; width: 14%; color: #000;">'.utf8_encode($periodos).'</td>
