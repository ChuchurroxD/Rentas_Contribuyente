...
{
    public partial class Frm_ReporteHRPUPR : DockContent
    {
        ...
        private void rbtCodContribuyente_CheckedChanged(object sender, EventArgs e)
        {
            if (rbtCodContribuyente.Checked)
            {
                string texto = txtCodContribuyente.Text.Trim();
                if (texto.Length != 0)
                    listarBuscado("", texto, "");
            }
        }
        ...
        private void comboBusquedaPeriodoInicial_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int cantidad;
        ...
        private void comoBusquedaPeriodoFinal_SelectedIndexChanged(object sender, EventArgs e)
        {
