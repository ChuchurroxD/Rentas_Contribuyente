...
{
    public partial class Frm_ContribuyenteLiquidacion : DockContent
    {
        ...
        public Frm_ContribuyenteLiquidacion()
        {
            InitializeComponent();
        ...
        private void dgvContribuyenteBuscados_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                try
            {
                ...
                string direccionCompleta = (string)dgvContribuyenteBuscados.Rows[e.RowIndex].Cells["direccCompleta"].Value;
                Frm_Liquidacion Frm_Liqui = new Frm_Liquidacion(nombres, documento, persona, direccionCompleta);
                Frm_Liqui.StartPosition = FormStartPosition.CenterParent;
                Frm_Liqui.ShowDialog();
            }
            catch (Exception ex)
            {
                MessageBox.Show("No se pudo invocar el formulario",Globales.Global_MessageBox, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
        ...
        {
            FrmListadoLiquidacion Frm_Liqui = new FrmListadoLiquidacion();
            Frm_Liqui.StartPosition = FormStartPosition.CenterParent;
            Frm_Liqui.ShowDialog();
        }
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Frm_BusquedaAvanzada Frm_Liqui = new Frm_BusquedaAvanzada();
            Frm_Liqui.StartPosition = FormStartPosition.CenterParent;
            Frm_Liqui.ShowDialog();
        }
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            dgvContribuyenteBuscados.DataSource = new List<Mant_Per_Cont>();
        }
    }
}
