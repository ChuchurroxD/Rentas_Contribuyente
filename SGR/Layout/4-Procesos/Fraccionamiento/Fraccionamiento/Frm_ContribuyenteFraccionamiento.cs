...
{
    public partial class Frm_ContribuyenteFraccionamiento : DockContent
    {
        ...
        public Frm_ContribuyenteFraccionamiento()
        {
            InitializeComponent();
        ...
        private void dgvContribuyenteBuscados_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                Frm_Fraccionamiento Frm_Liqui = new Frm_Fraccionamiento(nombres, documento, persona, direccionCompleta);
