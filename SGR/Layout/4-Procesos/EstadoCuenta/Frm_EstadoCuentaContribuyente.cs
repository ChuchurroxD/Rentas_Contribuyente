...
{
    public partial class Frm_EstadoCuentaContribuyente : DockContent
    {
        ...
        private int periodo;
        public Frm_EstadoCuentaContribuyente()
        {
            InitializeComponent();
            llenarTipoSector();
        ...
        private void Frm_EstadoCuentaContribuyente_Load(object sender, EventArgs e)
        {

        }
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            Frm_EstadoCuentaDetalle frmEstadoCuentaDetalle = new Frm_EstadoCuentaDetalle(obtenerObjeto());
            frmEstadoCuentaDetalle.StartPosition = FormStartPosition.CenterParent;
            frmEstadoCuentaDetalle.ShowDialog();
        }
