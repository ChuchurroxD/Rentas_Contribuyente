...
{
    public partial class Frm_Fiscalizacion_Detalle : Form
    {
        ...
        private Pred_OtrasIntalacionesFisDataService OtrasInstalacionesFisDataService = new Pred_OtrasIntalacionesFisDataService();
        ...
        private Pred_PisosFisDataService PisosFisDataService = new Pred_PisosFisDataService();
        ...
        //(Pred_Predio, perso, paterno+" "+ materno+" "+ nombres,cboPeriodo.SelectedValue.ToString());
        public Frm_Fiscalizacion_Detalle(Pred_Predio pre, String persona_id, String persona_name, String año)
        {
            try
            {
                ...
                ColeccionOtrasInstalaciones = OtrasInstalacionesFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), año);
                dgvOtrasInstalaciones.DataSource = ColeccionOtrasInstalaciones;
                ColeccionPisos = PisosFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), año);
                dgvPisos.DataSource = ColeccionPisos;
                ColeccionPredioContribuyente = PredContribuyenteDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), Convert.ToInt16(año));
                ...
                dgvTablaArancelArb.DataSource = mant_TablaArancelDataService.listarActivosConCosto(predioGlobal.predio_ID.Trim(), lblAño.Text);
                dgvArbitriosAsignados.DataSource = pred_PrredioArbitrioDataService.listartodos(predioGlobal.predio_ID.Trim(), lblAño.Text);

                //dgvTablaArancelArb.DataSource = mant_TablaArancelDataService.listarActivosConCosto(predioGlobal.predio_ID, cboAnioIni.SelectedValue.ToString());
                //dgvArbitriosAsignados.DataSource = pred_PrredioArbitrioDataService.listartodos(predioGlobal.predio_ID, cboAnioIni.SelectedValue.ToString());
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                       ...
                       txtCuadra.Text, predio.kilometro) > 0)
                {
                    ...
                    //return;
                    //msj = msj + "Ya existe predio en dirección";
                ...
                if (MessageBox.Show(msj, Globales.Global_MessageBox, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    Pred_PredioDataService.Update(predio, Convert.ToInt32(lblAño.Text));
                    if(!ckbSoloAnio.Checked)
                    FiscalizacionDataService.HacerCambios(cboAnioIni.SelectedValue.ToString(), cboAnioFin.SelectedValue.ToString(), persona_id_seleccionadanueva, predio.predio_ID, usser, lblAño.Text);
        ...
        private void toolnuevoOtrasInstalaciones_Click(object sender, EventArgs e)
        {
            try
            {
                Frm_OtrasIntalaciones_Detalle Frm_OtrasIntalaciones_Detalle = new Frm_OtrasIntalaciones_Detalle(predioGlobal.predio_ID.Trim(), Convert.ToInt32(lblAño.Text));
                Frm_OtrasIntalaciones_Detalle.StartPosition = FormStartPosition.CenterParent;
                Frm_OtrasIntalaciones_Detalle.ShowDialog();
                ColeccionOtrasInstalaciones = OtrasInstalacionesFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), lblAño.Text);
                dgvOtrasInstalaciones.DataSource = ColeccionOtrasInstalaciones;
            }
            catch (Exception ex)
            {
        ...
        private void tooleditarOtrasInstalaciones_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Frm_OtrasIntalaciones_Detalle Frm_OtrasIntalaciones_Detalle = new Frm_OtrasIntalaciones_Detalle(obtenerdatosInstalaciones(), Convert.ToInt32(lblAño.Text));
                    Frm_OtrasIntalaciones_Detalle.StartPosition = FormStartPosition.CenterParent;
                    Frm_OtrasIntalaciones_Detalle.ShowDialog();
                    ColeccionOtrasInstalaciones = OtrasInstalacionesFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), lblAño.Text);
                    dgvOtrasInstalaciones.DataSource = ColeccionOtrasInstalaciones;
        ...
        private void toolnuevoContribuyentePredio_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Frm_PredioContribuyente_Detalle = new Frm_PredioContribuyente_Detalle(predioGlobal.predio_ID.Trim(), lblAño.Text);
        ...
        private void ContribuyentePrediolistarByPredio()
        {
            try
            {
                dgvContribuyentePredio.DataSource = PredContribuyenteDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), Convert.ToInt16(lblAño.Text));
        ...
        private void toolnuevoPisos_Click(object sender, EventArgs e)
        {
            try
            {
                Frm_Pisos_Detalle Frm_Pisos_Detalle = new Frm_Pisos_Detalle(predioGlobal.predio_ID.Trim(), Convert.ToInt32(lblAño.Text));
                Frm_Pisos_Detalle.StartPosition = FormStartPosition.CenterParent;
                Frm_Pisos_Detalle.ShowDialog();
                ColeccionPisos = PisosFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), lblAño.Text);
                dgvPisos.DataSource = ColeccionPisos;
                ActualizarAreaConstruida();
            }
            catch (Exception ex)
        ...
        private void tooleditarPisos_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Frm_Pisos_Detalle Frm_Pisos_Detalle = new Frm_Pisos_Detalle(obtenerdatosPiso(), Convert.ToInt32(lblAño.Text));
                    Frm_Pisos_Detalle.StartPosition = FormStartPosition.CenterParent;
                    Frm_Pisos_Detalle.ShowDialog();
                    ColeccionPisos = PisosFisDataService.listarByPredioID(predioGlobal.predio_ID.Trim(), lblAño.Text);
                    dgvPisos.DataSource = ColeccionPisos;
        ...
        private void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    this.tabControl1.Controls.Clear();
                //    List<Mant_Depreciacion> lista = FiscalizacionDataService.verificarArancelDepreciacion(predioGlobal.predio_ID.Trim(), cboAnioIni.SelectedValue.ToString(), cboAnioFin.SelectedValue.ToString());
                //    if (lista.Count > 0)
                //    {
                //        this.tabControl1.Controls.Add(this.tbpErrores);
                //        int num = 0;
                ...
                //        PintarLblPorcentaje(total);
                //        ActualizarAreaConstruida();
                //        MessageBox.Show("Parámetros Completos", Globales.Global_MessageBox);
                //    }
            ...
            //if existen parametros modificar
        ...
        private void cargarArancel()
        {
            try
            {
                    ...
                    String.Compare(cboSector.SelectedValue.ToString().Trim(), "") != 0)//URBANO
                {
                    ...
                    valor = mant_ArancelDataService.GetMonto(jv, Convert.ToInt32(lblAño.Text), Convert.ToInt32(txtLado.Text), Convert.ToInt32(txtCuadra.Text));
                ...
                {
                    valor = mant_ArancelRusticoDataService.GetMontoRustico(cboClasificacionRustico.SelectedValue.ToString().Trim(), Convert.ToInt32(lblAño.Text), cboCategoriaRustico.SelectedValue.ToString().Trim());
                    lblArancel.Text = valor.ToString();
                }
                else
                    lblArancel.Text = "0";
        ...
        private void Frm_Fiscalizacion_Detalle_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (!cerro)
        ...
        private void toolAgregarArbitrio_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pred_PrredioArbitrio.Predio_id = predioGlobal.predio_ID;
                ...
                for (int i = 0; i < cantidad; i++)
                {
                    ...
                    if (bandera)
                    {
                        ...
                        {
                            pred_PrredioArbitrio.idPeriodo = lblAño.Text;
                ...
                else
                {
                    ...
                    dgvTablaArancelArb.DataSource = mant_TablaArancelDataService.listarActivosConCosto(predioGlobal.predio_ID, lblAño.Text);
                    dgvArbitriosAsignados.DataSource = pred_PrredioArbitrioDataService.listartodos(predioGlobal.predio_ID, lblAño.Text);
                }
                ActualizarTotalArbitrio();
            }
            catch (Exception ex)
        ...
        private void modificarEstadoArbitriosAsignados(bool bande)
        {
            try
            {
                ...
                if (dgvArbitriosAsignados.SelectedRows.Count > 0)
                {
                    ...
                    pred_PrredioArbitrio.Predio_id = predioGlobal.predio_ID;
                    dgvTablaArancelArb.DataSource = mant_TablaArancelDataService.listarActivosConCosto(pred_PrredioArbitrio.Predio_id,lblAño.Text );
                    dgvArbitriosAsignados.DataSource = pred_PrredioArbitrioDataService.listartodos(pred_PrredioArbitrio.Predio_id, lblAño.Text);
                    if (bande)
        ...
        private void gpbArancelarioRustico_Enter(object sender, EventArgs e)
        {
